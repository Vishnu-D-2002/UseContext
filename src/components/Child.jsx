...
function Child() {
  ...
  return (
    <div className="container-fluid px-0" id='boxs'>
      <div className="row justify-content-center" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
        {context.products.map(product => (
          <div key={product.id} className="col-12 mx-auto px-0">
